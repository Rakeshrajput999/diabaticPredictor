...
def st_diabatic(diabatic_html,width =700,height =800):
...
df = pd.read_csv(r'/home/rakesh/Documents/gitClone/diabetes_prediction/diabetes.csv')

# navbar 
navbar = option_menu("MALLITUS PREDICARE", ["Home", "Diet",  "Doctor", 'Blog'], 
...
if navbar == "Diet":
  st.markdown("diet paln")
  st_diabatic("diet.html")




if navbar == "Doctor":
  st.markdown("Doctor Cunsultency")
  st_diabatic("diet.html")

if navbar == "Blog":
  st.markdown("Diabatic")
  st_diabatic("blog.html")
